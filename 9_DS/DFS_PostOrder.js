//? In Pre Order we visit the node first, the left and then right

// * In Post Order we visit the node after we have looked at the left and right.

// * The Root is the visited last, for any node we visit all children first and then the node
